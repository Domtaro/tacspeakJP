...
ingame_key_bindings = {
    ...
    "cmd_mod_vehicle_fire": ("com_rctrl", "5",),
    "cmd_mod_vehicle_cease_fire": ("com_rctrl", "6",),
    "cmd_mod_vehicle_manual_fire": ("com_rctrl", "7",),
    "cmd_mod_vehicle_c_manual_fire": ("com_rctrl", "8",),
    "cmd_mod_vehicle_sw_cannon": ("com_rctrl", "numpad1",),
    "cmd_mod_vehicle_sw_mg": ("com_rctrl", "numpad2",),
    "cmd_mod_vehicle_sw_missile": ("com_rctrl", "numpad3",),
    "cmd_mod_vehicle_sw_rocket": ("com_rctrl", "numpad4",),
    "cmd_mod_vehicle_load_ap": ("com_rctrl", "numpad5",),
    "cmd_mod_vehicle_load_he": ("com_rctrl", "numpad6",),
    "cmd_mod_vehicle_mv_forward": ("com_rctrl", "w",),
    "cmd_mod_vehicle_mv_backward": ("com_rctrl", "s",),
    "cmd_mod_vehicle_mv_stop": ("com_rctrl", "x",),
    "cmd_mod_vehicle_mv_fast": ("com_rctrl", "e",),
    "cmd_mod_vehicle_mv_slow": ("com_rctrl", "q",),
    "cmd_mod_vehicle_mv_left": ("com_rctrl", "a",),
...
map_all_command = {
    ...
    "fire": "cmd_mod_vehicle_fire",
    "ふぁいあ": "cmd_mod_vehicle_fire",
    "ふぁいや": "cmd_mod_vehicle_fire",
    "[つづけ て] うて": "cmd_mod_vehicle_fire",
    "[つづけ て] うで": "cmd_mod_vehicle_fire",
    "[つづけ て] うけ": "cmd_mod_vehicle_fire",
    "[つづけ て] いて": "cmd_mod_vehicle_fire",
    "[つづけ て] れて": "cmd_mod_vehicle_fire",
    "[つづけ て] はっしゃ": "cmd_mod_vehicle_fire",
    "cease fire": "cmd_mod_vehicle_cease_fire",
    "しーす ふぁいあ": "cmd_mod_vehicle_cease_fire",
    "しーす ふぁいや": "cmd_mod_vehicle_cease_fire",
    "うつな": "cmd_mod_vehicle_cease_fire",
    "manual fire": "cmd_mod_vehicle_manual_fire",
    "cancel manual fire": "cmd_mod_vehicle_c_manual_fire",
    "まにゅある ふぁいあ": "cmd_mod_vehicle_manual_fire",
    "まにゅある ふぁいや": "cmd_mod_vehicle_manual_fire",
    "きゃんせる まにゅある ふぁいあ": "cmd_mod_vehicle_c_manual_fire",
    "きゃんせる まにゅある ふぁいや": "cmd_mod_vehicle_c_manual_fire",
    "しゅほう [に] [きりかえ]": "cmd_mod_vehicle_sw_cannon",
    "[switch] [to] cannon": "cmd_mod_vehicle_sw_cannon",
    "きゃのん [に] [きりかえ]": "cmd_mod_vehicle_sw_cannon",
    "きじゅう [に] [きりかえ]": "cmd_mod_vehicle_sw_mg",
    "[switch] [to] machine gun": "cmd_mod_vehicle_sw_mg",
    "ましんがん [に] [きりかえ]": "cmd_mod_vehicle_sw_mg",
    "[switch] [to] mg": "cmd_mod_vehicle_sw_mg",
    "えむじー [に] [きりかえ]": "cmd_mod_vehicle_sw_mg",
    "[switch] [to] missile": "cmd_mod_vehicle_sw_missile",
    "みさいる [に] [きりかえ]": "cmd_mod_vehicle_sw_missile",
    "ゆうどうだん [に] [きりかえ]": "cmd_mod_vehicle_sw_missile",
    "[switch] [to] rocket": "cmd_mod_vehicle_sw_rocket",
    "ろけっと [に] [きりかえ]": "cmd_mod_vehicle_sw_rocket",
    "てっこう だん [そうてん]": "cmd_mod_vehicle_load_ap",
    "だんしゅ (てっこう | てっこう だん)": "cmd_mod_vehicle_load_ap",
    "じだん (てっこう | てっこう だん)": "cmd_mod_vehicle_load_ap",
    "(A P だん | えー ぴー だん) [そうてん]": "cmd_mod_vehicle_load_ap",
    "だんしゅ (A P | A P だん | えー ぴー | えー ぴー だん)": "cmd_mod_vehicle_load_ap",
    "じだん (A P | A P だん | えー ぴー | えー ぴー だん)": "cmd_mod_vehicle_load_ap",
    "(りゅうだん | りゅう だん) [そうてん]": "cmd_mod_vehicle_load_he",
    "だんしゅ (りゅうだん | りゅう だん)": "cmd_mod_vehicle_load_he",
    "じだん (りゅうだん | りゅう だん)": "cmd_mod_vehicle_load_he",
    "(H E だん | えいち いー だん) [そうてん]": "cmd_mod_vehicle_load_he",
    "だんしゅ (H E | H E だん | えいち いー | えいち いー だん)": "cmd_mod_vehicle_load_he",
    "じだん (H E | H E だん | えいち いー | えいち いー だん)": "cmd_mod_vehicle_load_he",
    "[つづけ て] [せんしゃ] ぜんしん [しろ | せよ | だ]": "cmd_mod_vehicle_mv_forward",
    "[つづけ て] [せんしゃ] すすめ": "cmd_mod_vehicle_mv_forward",
    "[つづけ て] [せんしゃ] ちょくしん [しろ | せよ | だ]": "cmd_mod_vehicle_mv_forward",
    "[つづけ て] [せんしゃ] こうたい [しろ | せよ | だ]": "cmd_mod_vehicle_mv_backward",
    "[つづけ て] [せんしゃ] こうしん [しろ | せよ | だ]": "cmd_mod_vehicle_mv_backward",
    "[つづけ て] [せんしゃ] さがれ": "cmd_mod_vehicle_mv_backward",
    "[つづけ て] [せんしゃ] ていし [しろ | せよ | だ]": "cmd_mod_vehicle_mv_stop",
    "[つづけ て] [せんしゃ] ていしゃ [しろ | せよ | だ]": "cmd_mod_vehicle_mv_stop",
    "[つづけ て] [せんしゃ] ぶれーき [しろ | せよ | だ]": "cmd_mod_vehicle_mv_stop",
    "つづけ て [せんしゃ] とまれ": "cmd_mod_vehicle_mv_stop",
    "ぜんそく [りょく]": "cmd_mod_vehicle_mv_fast",
    "ていそく [りょく]": "cmd_mod_vehicle_mv_slow",
    "[つづけ て] [せんしゃ] ひだり": "cmd_mod_vehicle_mv_left",
    "[つづけ て] [せんしゃ] させつ": "cmd_mod_vehicle_mv_left",
    "[つづけ て] [せんしゃ] ひだりせんかい [しろ | せよ | だ]": "cmd_mod_vehicle_mv_left_keep",
    "[つづけ て] [せんしゃ] ひだり せんかい [しろ | せよ | だ]": "cmd_mod_vehicle_mv_left_keep",
    "[つづけ て] [せんしゃ] ひだり に (せんかい [しろ | せよ | だ] | まわれ)": "cmd_mod_vehicle_mv_left_keep",
    "[つづけ て] [せんしゃ] みぎ": "cmd_mod_vehicle_mv_right",
    "[つづけ て] [せんしゃ] うせつ": "cmd_mod_vehicle_mv_right",
